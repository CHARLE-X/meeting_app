...
//   const initialMeetingTitle = searchParams.get('meeting_title') || 'Unknown Meeting';
//   const initialTemplate = searchParams.get('template') || 'No Template';
//   const initialFileName = searchParams.get('file_path')?.split('/').pop() || 'No File Uploaded';
...
//         setTemplate(data.meeting.template_name);
//         setFileName(data.meeting.file_name || 'No File Uploaded');
//       } catch (error) {
...
//   const handleEdit = () => {
//     router.push(`/dashboard/editmeeting?meeting_id=${meetingId}`);
//   };
